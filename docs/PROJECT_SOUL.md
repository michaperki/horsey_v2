...
**Avatar semantics.** The avatar is public identity, not a generic skin doll. Base chess piece communicates chess-strength / rating class; frame communicates trust and account status; adornments communicate earned history, rewards, live state, stable identity, or shop-safe expression. Do not sell or grind-gate base-piece upgrades, and do not let adornments impersonate trust. See `docs/COSMETICS_FORMALIZATION.md` § 5.0.
